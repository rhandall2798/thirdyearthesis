...
<html lang="en">
  <head>
    ...
    <title>Moderator Area | Dashboard</title>
    <!-- Bootstrap core CSS -->
      ...
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            <li class="active"><a href="../ModeratorDesign/index.php">Dashboard</a></li>
        ...
        <div class="row">
          <div class="col-md-3">
            <div class="list-group">
              <a href="../ModeratorDesign/index.php" class="list-group-item active main-color-bg">
