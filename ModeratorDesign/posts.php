...
<html lang="en">
  <head>
    ...
    <title>Moderator Area | Posts</title>
    <!-- Bootstrap core CSS -->
      ...
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            <li><a href="../ModeratorDesign/pages.php">Suggestions</a></li>
            <li class="active"><a href="../ModeratorDesign/posts.php">Complaints</a></li>
            <li><a href="../ModeratorDesign/users.php">Users</a></li>
          </ul>
        ...
        <div class="row">
          <div class="col-md-3">
            <div class="list-group">
              ...
              <a href="../ModeratorDesign/pages.php" class="list-group-item"><span class="glyphicon glyphicon-list-alt" aria-hidden="true"></span> Suggestions <span class="badge"><?php echo $suggestionid;?></span></a>
              <a href="../ModeratorDesign/posts.php" class="list-group-item active main-color-bg"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span> Complaints <span class="badge"><?php echo $complaintid; ?> </span></a>
            </div>
