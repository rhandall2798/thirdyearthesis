        ...
        <div class="row">
          <div class="col-md-3">
            <div class="list-group">
              ...
              <a href="../ModeratorDesign/pages.php" class="list-group-item"><span class="glyphicon glyphicon-list-alt" aria-hidden="true"></span> Suggestions <span class="badge"><?php echo $suggestioncountid; ?></span></a>
              <a href="../ModeratorDesign/posts.php" class="list-group-item active main-color-bg"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span> Complaints <span class="badge"><?php echo $complaintcountid; ?> </span></a>
            </div>
