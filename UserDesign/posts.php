        ...
        <div class="row">
          <div class="col-md-3">
            <div class="list-group">
              ...
              <a href="../UserDesign/posts.php" class="list-group-item active main-color-bg"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span> Complaints <span class="badge"><?php echo $complaintid; ?> </span></a>
            </div>
          ...
          <div class="col-md-9">
            ...
            <div class="panel panel-default">
              ...
              <div class="panel-body">
                    ...
                    <button class="btn btn-default pull pull-right" data-toggle="modal" data-target="#addComplaint" id="addMemberModalBtn" onclick="addComplaint">
                <span class="glyphicon glyphicon-plus-sign"></span>	Add Complaints
                </button>
                  <br>
                  <br>
                  <br>
