...
<html lang="en">
  <head>
    ...
    <title>User Area | Complaints</title>
    <!-- Bootstrap core CSS -->
      ...
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="../UserDesign/pages.php">Suggestions</a></li>
          ...
          <div class="col-md-3">
            <div class="list-group">
             ...
             <span class="glyphicon glyphicon-cog" aria-hidden="true"></span> Dashboard
              ...
              <a href="../UserDesign/pages.php" class="list-group-item active main-color-bg"><span class="glyphicon glyphicon-list-alt" aria-hidden="true"></span> Suggestions <span class="badge"><?php echo $suggestionid;  ?></span></a>
          ...
          <div class="col-md-9">
            ...
            <div class="panel panel-default">
              ...
              <div class="panel-body">
                                   <button class="btn btn-default pull pull-right" data-toggle="modal" data-target="#addSuggestion" id="addMemberModalBtn" onclick="addSuggestion">
                <span class="glyphicon glyphicon-plus-sign"></span>	Add Suggestion
                </button>
